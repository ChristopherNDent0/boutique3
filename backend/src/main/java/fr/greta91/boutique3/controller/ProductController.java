...
public class ProductController {
	...
	public List<Product> getProductsByName(@PathVariable String productName) {
		...
		List<Product> list = productRepo.findByProductNameContainingIgnoreCase(productName);
		return list;
	}
	...
	//@RequestMapping(value = "/productName/{productName}", method = RequestMethod.GET)
	public List<Product> getProductsByCategoryId(@PathVariable (value ="categoryId")int categoryId) {
		List<Product> list = productRepo.findByCategory(categoryId);
		return list;
	}
}
